...
% \cite prints nothing (\unskip removes the space it would leave behind), and
% the thebibliography block at the end of the file is wrapped in \iffalse..\fi.
%
% TO RESTORE: delete the \renewcommand below, and delete the \iffalse / \fi
% lines around the bibliography at the end of this file. Every \cite key is
% still in place, so nothing else needs editing.
% -----------------------------------------------------------------------------
...
\FILL{insert final venue and year}.
